...
public class MainActivity extends Activity {
    ...
    public void alta(View v) {
        ...
        String run    = et1.getText().toString().trim().toUpperCase();
        String nombre = et2.getText().toString().trim().toUpperCase();
        String ciudad = et3.getText().toString().trim().toUpperCase();
        String numero = et4.getText().toString().trim().toUpperCase();
    ...
    public void consulta(View v) {
        ...
        Cursor fila = bd.rawQuery(
                "select nombre, ciudad, numero from usuario where run='"+run+"'", null);
        ...
        if (fila.moveToFirst()) {
            ...
            Toast.makeText(this, "No existe ningún usuario con ese run",
    ...
    public void baja(View v) {
        ...
        int cant = bd.delete("usuario", "run='" + run+"'", null);
        bd.close();
        et1.setText("");
        et2.setText("");
        et3.setText("");
    ...
    public void modificacion(View v) {
        ...
        int cant = bd.update("usuario", registro, "run= '" + run+"'", null);
        bd.close();
        if (cant == 1)
